...
const PLANETS: PlanetData[] = [
  {
    ...
    left: SCREEN_WIDTH / 2 - 148 * 0.95,
    coreColor: colors.accentPurple,
    midColor: '#B18CFF',
    shadowColor: '#2E1065',
    glowColor: colors.accentPurple,
    ringColor: colors.accentPurpleLight,
    hasRing: true,
    hasMoon: true,
  },
  {
    ...
    coreColor: colors.accentTeal,
    midColor: '#8FF3FF',
    shadowColor: '#083344',
    glowColor: colors.accentTeal,
    ringColor: colors.accentTealLight,
    hasRing: true,
    hasMoon: true,
  },
  {
